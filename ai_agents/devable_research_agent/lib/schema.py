"""Data schema for devable-research-agent items."""
...
class TrackerItem:
    ...
    source: str = ""  # x | reddit | hackernews | github | huggingface | arxiv | web | repo
    source_url: str = ""
    ...
    importance: float = 0.0  # 1-10 devable-research-agent scale (set by scoring)
