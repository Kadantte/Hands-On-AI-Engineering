"""HTTP utilities for devable-research-agent (stdlib only, adapted from last30days)."""
...
MAX_RETRIES = 5
RETRY_DELAY = 2.0
USER_AGENT = "devable-research-agent/1.0 (AI Industry Tracker)"
...
def get_text(url: str, headers: Optional[Dict[str, str]] = None, **kwargs) -> str:
    """GET request returning raw text (not parsed as JSON)."""
